...
export default class StudentsManagement extends Component {
    constructor(props) {
        super(props)
        this.state = {
            users: 0,
    ...
    componentDidMount() {
        StudentService
            .getStudentsByPage(this.state.page, this.state.usersPerPage)
            .then(response => {
                this.setState({
    ...
    onClickConfirmDelete = () => {
        StudentService
            .deleteStudentById(this.state.selectedUserId)
            .then(() => {
                StudentService
                    .getUsersByPage(this.state.page, this.state.usersPerPage)
                    .then((response) => {
    ...
    onClickUpdateUsersByPage = (usersPerPage) => {
        if (this.state.searchQuery === '') {
            ...
            StudentService
                .getStudentsByPage(this.state.page, usersPerPage)
                .then(response => {
                    this.setState({
                        ...this.state,
                        displayedUsers: response,
            ...
            StudentService
                .getStudentsBySearchQueryCount(this.state.searchQuery)
                .then(response => {
                    this.setState({
                        users: response,
                        pages: Math.floor(response / usersPerPage) + 1
            ...
            StudentService
                .getStudentsByPageAndSearchQuery(this.state.page, usersPerPage, this.state.searchQuery)
                .then(response => {
                    this.setState({
                        ...this.state,
                        displayedUsers: response,
    ...
    onChangeQueryString = (event) => {
        ...
        if (event.target.value === '') {
            ...
            StudentService
                .getStudentsBySearchQueryCount(event.target.value)
                .then(response => {
                    this.setState({
                        users: response,
                        pages: Math.floor(response / this.state.usersPerPage) + 1
            ...
            StudentService
                .getStudentsByPageAndSearchQuery(this.state.page, this.state.usersPerPage, event.target.value)
                .then(response => {
                    this.setState({
                        ...this.state,
                        displayedUsers: response
    ...
    onClickChangePage = (page) => {
        if (this.state.searchQuery === '') {
            ...
            StudentService
                .getStudentsByPage(page, this.state.usersPerPage)
                .then(response => {
                    this.setState({
                        ...this.state,
                        displayedUsers: response,
            ...
            StudentService
                .getStudentsByPageAndSearchQuery(page, this.state.usersPerPage, this.state.searchQuery)
                .then(response => {
                    this.setState({
                        ...this.state,
                        displayedUsers: response,
