...
namespace Metis.API.Controllers
{
    ...
    public class UserController : BaseController
    {
        ...
        public async Task<IActionResult> AddUserAsync(AddUserRequest model)
        {
            ...
            IdentityResult result = await UserManager.AddUser(_dataContext, _userManager, model.FirstName, model.LastName, model.Email, model.DictionaryId, password, model.Lessons.Select(d => d.Id));
            if (!result.Succeeded)
            {
        ...
        public async Task<IActionResult> GetUserByIdAsync(int id)
        {
            ...
            model.User = await UserManager.GetUserById(_dataContext, id);
        ...
        {
            var result = await UserManager.EditUser(_dataContext, _userManager, model.Id, model.FirstName, model.LastName, model.Email, model.DictionaryId, model.Lessons.Select(d => d.Id));
