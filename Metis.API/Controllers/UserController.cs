...
namespace Metis.API.Controllers
{
    ...
    public class UserController : BaseController
    {
        ...
        public async Task<IActionResult> AddUserAsync(AddUserRequest model)
        {
            ...
            IdentityResult result = await UserManager.AddUser(_dataContext, _userManager, model.FirstName, model.LastName, model.Email, password, model.Lessons.Select(d => d.Id));
            if (!result.Succeeded)
            {
        ...
        {
            var result = await UserManager.EditUser(_dataContext, _userManager, model.Id, model.FirstName, model.LastName, model.Email, model.Lessons.Select(d => d.Id));
